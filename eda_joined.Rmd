...
diabetes_factors = 
  ...
  select(high_bp, high_bs, a1c_check, chol_meds, chol_check, smoker, ecigs, prediabetic, obese, cancer, heavy_drinking, binge_drinking, has_diabetes, diab_type, eval_type) |> 
  rename(
...
## High blood sugar {.tabset} - may not use
...
```{r}
factor = "Checked A1C in the Past Year"
```
