...
variables = c("_AGEG5YR", "_SMOKER3", "_STATE", "_URBSTAT", "ADDEPEV3", "ASTHMA3", "ASTHNOW", "BPHIGH6", "CHCCOPD3", "CHCKDNY2", "CHKHEMO3", "COVIDPO1", "CVDCRHD4", "CVDINFR4", "CVDSTRK3", "DIABAGE4", "DIABETE4", "DIABTYPE", "EDUCA", "EXERANY2", "EXEROFT1", "HAVARTH4", "HEIGHT3", "INSULIN1", "PDIABTS1", "PREDIAB2", "PREGNANT", "SEXVAR", "SMOKE100", "TOLDHI3", "WEIGHT2")
